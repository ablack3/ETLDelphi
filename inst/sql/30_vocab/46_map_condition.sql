-- Condition mapping: Problem_Code (ICD10/ICD9/SNOMED/Medcin) -> condition_concept_id via cdm.concept and Maps to.
-- condition_source_value = Problem_Code or Problem_Description. Unmapped -> 0.
...
LEFT JOIN cdm.concept src
    ON src.concept_code = p.problem_code
   AND src.vocabulary_id IN ('ICD10CM', 'ICD10', 'ICD9CM', 'SNOMED', 'Medcin')
