...
con <- dbConnect(duckdb::duckdb(), "~/Desktop/delphi.duckdb")
cdm <- cdmFromCon(con, cdm_schema = "cdm", write_schema = "main")
```
...
```{r scorecard-assessment, results='asis'}
