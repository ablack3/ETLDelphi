---
title: "Oncology Data Diagnostic Template"
output:
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Oncology Data Diagnostic Template}
...
This vignette is a reusable analysis template for checking whether an OMOP CDM
dataset is suitable for oncology research. It examines the presence and depth
of cancer-related data across four clinical
...
markers, which are critical for many oncology study designs.

All code is shown but not executed during the package build. Replace the example
connection below with your own OMOP CDM database before running the workflow.

# Setup

Connect to your CDM database and load the required libraries.
